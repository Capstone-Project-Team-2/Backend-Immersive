...
func (repo *AdminData) Login(email string, password string) (string, string, string, string, error) {
	...
	return token, adminModel.ID, adminModel.Name, adminModel.Role, nil
}
